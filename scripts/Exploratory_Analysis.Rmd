...
```{r upset-plot, fig.width=20, fig.height=10, echo=FALSE}
...
```{r venn-diagram, fig.width=6, fig.height=6, echo=FALSE}
...
```{r ven_eur_afr, fig.width=5, fig.height=5, echo=FALSE}
plot_venn("EUR", "AFR", "#00B0F6", "#F8766D")
```
####Venn Diagram of EUR and AMR
```{r ven_eur_amr, fig.width=5, fig.height=5, echo=FALSE}
grid.newpage()
grid.draw(plot_venn("EUR", "AMR", "#00B0F6", "#A3A500"))
```
####Venn Diagram of EUR and EAS
```{r ven_eur_eas, fig.width=5, fig.height=5, echo=FALSE}
...
bedtools_boot <- full_join(bedtools, bed_boot, by = c("Population", "Phenotype"))
...
ggplot(
  ...
  labs(
    ...
    fill = "Superpopulation",
    alpha = "Study Stage",
    title = "GWAS Studies by Superpopulation and Stage"
  ) +
